    ...
    OPTConfig(std::string const &model_config_file_path) {
      ...
      if (config_file.is_open()) {
        try {
          ...
          if (model_config.contains("enable_bias")){
            enable_bias = model_config["enable_bias"];
          } else {
            enable_bias = true;
          }
          ...
          if (model_config.contains("layer_norm_elementwise_affine")) {
            layer_norm_elementwise_affine = model_config["layer_norm_elementwise_affine"];
          } else {
          ...
          if (model_config.contains("word_embed_proj_dim")){
            word_embed_proj_dim = model_config["word_embed_proj_dim"];
          } else {
            word_embed_proj_dim = model_config["hidden_size"];
          }
